INSERT INTO bots (name, description, pairing_code) VALUES (
	'Transition bot', 
	'Allows you to link your Bitcoin and InterValue addresses for participation in InterValue distribution.',
	'A2WMb6JEIrMhxVk+I0gIIW1vmM3ToKoLkNF8TqUV5UvX@XX.XXX.XXX/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	'Byte-BTC exchange', 
	'Buy or sell Bytes for BTC instantly. Advanced users can offer their price, post pending orders and see the order book.', 
	'Ar2ukVqx309sX+LoC9RVOpfATgXskt+Ser5jVr3Q2FOo@XX.XXX.XXX/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	...
	'AuP4ngdv0S/rok+IaW1q2D6ye72eXLl3h+CqXNXzkBXn@XX.XXX.XXX/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	'Sports oracle', 
	...
	'Ar1O7dGgkkcABYNAbShlY2Pbx6LmUzoyRh6F14vM0vTZ@XX.XXX.XXX/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	'BTC oracle', 
	...
	'A7C96Bhg4Gpb2Upw/Ky/YfGG8BKe5DjTiBuJFGAX50N1@XX.XXX.XXX/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	'Rosie bot', 
...
Developer: Laurentiu-Andronache, https://github.com/Laurentiu-Andronache/intervalue-chatbot-Rosie',
	'ApOpqXbI7GpqOl3Z96QW/GSNgv04g4RcFr/xpaDmN9cg@XX.XXX.XXX/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	'InterValue Asset Manager',
	'Asset directory and asset creation platform for InterValue. The chatbot provides a simple yet powerful interface to define and issue custom InterValue assets. Assets behave similarly to the native currency "bytes": they are transferable and exchangeable. They can represent anything that has value such as debt, shares, loyalty points, airtime minutes, commodities, other fiat or crypto currencies.

Developer: Peter Miklos, https://intervalue.market',
	'Ao2SRelXb23nTnom+KHhLIzK4nyk0WAlE3vRWk5K25Gg@XX.XXX.XXX/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	'Zork I game', 
...
Source code: https://github.com/intervalue/flight-delays-insurance, fork and write your bot.',
	'Ai8b8CdBxZkm6h1RVhYT7y6Scas/eNn1ccavU7dgHYqN@XX.XXX.XXX/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	'Poll bot', 
	'Vote in polls.  The weight of your vote is proportional to your balance.

Source code: https://github.com/intervalue/poll-bot',
	'AhMVGrYMCoeOHUaR9v/CZzTC34kScUeA4OBkRCxnWQM+@XX.XXX.XXX/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	...
	'AxV6ohKFORqIGfGqCZgjK1HlL8vBiNltcWWaI0Rc9yN+@intervalue.fr/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	...
	'ApSicldzuDl675iiUyWdmO7pLl8MPgeuNg4qOr13EkNJ@XX.XXX.XXX/bb#globalchat'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
...
Source code: https://github.com/intervalue/conditional-token-sale, you can use it to sell your tokens.',
	'AmXiHW7Ms4qcdmXeLW4U/ou5lv4HFnijYBGWGKfgT6bM@XX.XXX.XXX/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
...
Developer: papabyte.com',
    'AnpzF9nVTV5JZXzlG2fSnA+8UmjFuBdbqU+rJchz3qcN@XX.XXX.XXX/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
    'Luckybytes Lottery (provably fair)',
    'An in app lottery in which you can play using your InterValue Bytes. There are three different game modes to participate in. Win large amounts of Bytes depending on the number of players on the principle of "the winner takes all". All games are provably fair. Each lottey comes with a game and proof hash which lets a player validate and prove the results against manipulation.
    
Developer: pxrunes, https://lucky.byte-ball.com',
    'A5X5LT9HtUewgC6Zob3oRfoICNj34d44ZCRYmXnDmqdZ@XX.XXX.XXX/bb#LuckyBytes'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
    'TitanCoin ICO',
...
Project page and investor information: http://titan-coin.com',
    'AqXgqz9CIqi+pq9RKCVgs9wDBj+XMQdi4414XUjTFL3W@XX.XXX.XXX/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
    'InterValue-Altcoin Exchange Bot',
...
Developer: Robert Huber, http://intervalue-exchange-bot.com',
    'AiAuuTYQgLL9JBdkpfXU3pjm2RZklmObGAKYB5gJioBG@XX.XXX.XXX/bb#bytExchange'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
...
Developer: papabyte.com',
   'ArUEvvn+7tq0p6CbCqJtaVTSoDzX9Iot+Zd1bA40kcVB@XX.XXX.XXX/bb#0000'
);
INSERT INTO bots (rank, name, description, pairing_code) VALUES (
	2,
   ...
   'AsYnI7C8WuXqb2aLMSr0nfpLC+u3FRSLWwkp1e9ib15Z@XX.XXX.XXX/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
   'Fun-coins faucet',
...
Developer: papabyte.com',
   'A0dDO/XuMzELLq4r7F3/QMB3JOJQpbq40lAeCFdAX7yU@XX.XXX.XXX/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
   'SilentNotary ICO',
   'SilentNotary is a digital notary that saves and certifies documents, emails, chats, and audio/video recordings.  The authenticity of these records will be ensured by posting them both to Ethereum blockchain and InterValue DAG.  The ICO is active until 15 March 2018, and you can buy SNTR tokens with Bytes, BTC, or Ether.

Website: https://silentnotary.com',
   'Aop8UNeUm4Qtu0q2frAaVwkQtQiNGKYVL8NvdQYgrR+v@XX.XXX.XXX/bb#0000'
);
INSERT INTO bots (rank, name, description, pairing_code) VALUES (
	2,
   'Email attestation bot',
   'Verify your email adddress, and your payers don''t need to know your InterValue address any longer, they just write your email address as recipient.    After first successful verification, you are rewarded with $10.00 worth of Bytes from the distribution fund if your email is on one of whitelisted domains.',
   'Al+nIuRMIr8PGvi3BkIVU+S/VZ1Xm2SM3yR3z4IoyMbJ@XX.XXX.XXX/bb#0000'
);
INSERT INTO bots (rank, name, description, pairing_code) VALUES (
	2,
   'Exchange Bot',
   'Exchange InterValue-issued tokens against Bytes or token vs token.  The exchange is based on smart contracts, so you don''t have to trust the exchange operator.',
   'A8GXYB3lSvSsvej+ZQgfF2prwx8gopMx8j5JwwUS9ZVD@XX.XXX.XXX/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
   'Worldopoly ICO',
   'Worldopoly is the world’s first mobile game combining AR, AI, Geolocationing, Blockchain, and DAG. The ICO is active until 17 May 2018, and you can buy WPT tokens with Bytes, BTC, or Ether.  WPT token is issued both on InterValue and Ethereum platforms but investors on InterValue platform receive increased bonus (even if they pay in ETH or BTC) for investments up to 30 ETH.

Website: https://worldopoly.io',
   'AwyoKVsyxajATgLXa9Jhh8NBRTnUaZNHdi85c43g+GoJ@XX.XXX.XXX/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
...
开发者：123cb.net',
   'Ahe4jkq5GvgLQ2h5ftqRMjWBBumUEN96tWoSfEQ9TGHF@XX.XXX.XXX/bb#0000'
);
INSERT INTO bots (rank, name, description, pairing_code) VALUES (
	3,
   ...
   'A1i/ij0Na4ibEoSyEnTLBUidixtpCUtXKjgn0lFDRQwK@XX.XXX.XXX/bb#0000'
);
INSERT INTO bots (rank, name, description, pairing_code) VALUES (
	2,
